...
// Returns the private 'App\Repository\TemplatesCommentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TemplatesCommentRepository.php';

return $this->privates['App\Repository\TemplatesCommentRepository'] = new \App\Repository\TemplatesCommentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
