...
// Returns the private 'App\Repository\TemplatesDescriptionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TemplatesDescriptionRepository.php';

return $this->privates['App\Repository\TemplatesDescriptionRepository'] = new \App\Repository\TemplatesDescriptionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
