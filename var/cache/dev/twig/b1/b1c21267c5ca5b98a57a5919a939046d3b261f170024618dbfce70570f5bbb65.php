...
class __TwigTemplate_791cfc4d2320faae19a114df95bd24ae4fd877a0a67bcbd47a92a74c6a796e8e extends Twig_Template
{
    private $source;
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["template"]) {
            ...
            echo "</td>
                                        <th scope=\"col\"><a href=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_product", ["id" => twig_get_attribute($this->env, $this->source, $context["template"], "id", [])]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_product", ["id" => twig_get_attribute($this->env, $this->source, $context["template"], "id", [])]), "html", null, true);
            echo "</a></th>
...
";
    ...
    {
        return array (  154 => 37,  137 => 34,  133 => 33,  127 => 32,  123 => 31,  119 => 30,  115 => 29,  112 => 28,  95 => 27,  72 => 6,  63 => 5,  45 => 3,  15 => 1,);
    }
                            ...
                            <div class=\"table-responsive\">
                                <table class=\"table text-center\">
                                    ...
                                    <tr>
                                        ...
                                        <th scope=\"col\"><a href=\"{{ url('app_product',{'id':template.id}) }}\">{{ url('app_product',{'id':template.id}) }}</a></th>
